...
public class OutputWriter implements Closeable {
    ...
    public void writeObservablesVerbose(final long sweeps, final double m, final double currentEnergy, final double magField0, final double magField1, final double magField2,
                                 ...
                                 final double spinSizes0, final double spinSizes1, final double mk2, final double transFieldMaxConfig, final boolean lastSwapAccepted){
        if (outType == OutputType.VERBOSE) {
            Formatter formatter = new Formatter(outputBuffer);
            formatter.format(makeTableRowFormat(new char[]{'d', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'g', 'c'}), sweeps, m, currentEnergy, magField0, magField1, magField2, magField3, magField4, magField5, magField6, magField7, magField8, spinSizes0, spinSizes1, mk2, transFieldMaxConfig, (lastSwapAccepted ? '1' : '0'));
...
//		System.out.println(rowFormat.toString());
    ...
    public static class Builder {
        ...
        private String[] makeColHeaderNames(){
            ...
            switch (outType){
                case VERBOSE:
                    colNames = new String[]{"index", "Magnetization", "Energy", "meanBx", "stdBx", "meanBy", "stdBy", "meanBz", "stdBz", "maxBtrans", "maxBlong", "percBz", "meanSpinSize", "stdSpinSize", "mk2", "tMaxConfigs", "swap"};
                    break;
                case BIN:
                    colNames = new String[]{"binN", "<|M|>", "<|M|2>", "<M>", "<M2>", "<M2>", "<M22>", "<E>", "<E2>", "<meanBx>", "<meanBx2>",
                                            ...
                                            "<maxBtrans2>", "<maxBlong>", "<maxBlong2>", "<percBz>", "<percBz2>", "<meanSpinSize>",  "<meanSpinSize2>", "<stdSpinSize>", "<stdSpinSize2>", "<mk2>", "<mk22>", "<tMaxConfigs>", "<tMaxConfigs2>", "swap"};
                    break;
                case SPIN:
