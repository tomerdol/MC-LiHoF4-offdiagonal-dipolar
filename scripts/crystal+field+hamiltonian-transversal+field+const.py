...
This one keeps the magnetic moment constant as a function of Bz, thus eliminating the "hybridization"
between up and down which occurs at small longitudinal and significant transverse fields.
"""
import numpy as np
...
for i, bz in enumerate(Bz):
	...
	for by in By:
		...
		for bx in Bx:
			...
			# create an "effective" longitudinal field to break the near-degeneracy between up and down
			# which would cause significant hybridization which would significantly decrease the magnetic
			# moment. This should better mimic the physical behavior in the presence of hyperfine interaction.
