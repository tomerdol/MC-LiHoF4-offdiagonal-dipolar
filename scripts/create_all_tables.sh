#!/bin/sh
# Create all magnetic moment and energy interpolation tables
# for the defined external transverse magnetic fields
...
if [ $SYS_NAME == "LiHoF4" ]; then
    ...
    # In Fe8 the transverse magnetic field is applied at an angle relative to the crystal axes.
    # See E. Burzurí, F. Luis, B. Barbara, R. Ballou, E. Ressouche, O. Montero, J. Campo, and S. Maegawa,
    # Magnetic Dipolar Ordering and Quantum Phase Transition in an Fe_8 Molecular Magnet, Phys. Rev. Lett. 107, 097203 (2011).
    # https://link.aps.org/doi/10.1103/PhysRevLett.107.097203
    cosphi=0.375
    sinphi=0.927
fi
