#!/bin/bash
# Get preliminary results from a MC simulation to compare its energy to that obtained by exact
# diagonalization of the full system for a range of external x-direction magnetic fields

# list of external transverse magnetic fields
...
# read the results from the last half of the results file (to account for equilibration times)
